...
export default function Account() {
  ...
  return (
    <>
      <Head>
        <title>Edit Account - Zapgemini</title>
      </Head>
                    ...
                    <div className="col-span-6 sm:col-span-3 my-3">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          defaultValue={
                            profileData.skills &&
                            profileData.skills[1]?.skillName
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3 my-3">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          defaultValue={
                            profileData.skills &&
                            profileData.skills[2]?.skillName
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3 my-3">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          defaultValue={
                            profileData.skills &&
                            profileData.skills[3]?.skillName
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3 my-3">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          defaultValue={
                            profileData.skills &&
                            profileData.skills[4]?.skillName
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3 my-3">
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          defaultValue={
                            profileData.skills &&
                            profileData.skills[5]?.skillName
                          }
                        />
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-3 my-3">
                    ...
                    <input
                      ...
                      defaultValue={
                        profileData.skills && profileData.portfolioLink
                      }
                    />
                  </div>
