      ...
      <InView
        ...
        onChange={async (inView, entry) => {
          if (inView && profileCount >= users.length + 1) {
            setLoading(true);
            const fetchedUsers = (await axios(`/api/users?offset=${count}`))
              .data;
  ...
  return (
    <div>
      <Head lang="en">
        ...
        <title>
          Explore: Zapgemini - Find over 500+ developers creating impact in the
          tech ecosystem
        </title>
        <meta
          name="keywords"
        ...
        <meta
          name="title"
          content="Explore: Zapgemini - Find over 500+ developers creating impact in the tech ecosystem"
        />
        <meta
          name="description"
          content="Explore: Zapgemini - Find over 500+ developers creating impact in the tech ecosystem"
